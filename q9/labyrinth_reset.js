/**
 * 🔄 DATA LABYRINTH — SESSION RESET SCRIPT
 * ════════════════════════════════════════════
...
(async function resetLabyrinth() {
  console.log("%c 🔄 Initiating Labyrinth Reset...", "color: #f59e0b; font-weight: bold; font-size: 14px;");
  ...
  try {
    ...
    if (startData.session_token) {
      ...
      console.log(`🔑 Token: ${startData.session_token.slice(0, 15)}...`);
    } else {
